...
df_idrid = IOCTID_Process(data_dir)
...
train_ds = OCTDataset(df.image_id.values, df.diagnosis.values, target_type=target_type, crop=False, ben_color=True, dim=sz, transforms=train_aug)
