...
class Hybrid(nn.Module):
    def __init__(self, normalize_attn=False):
        ...
        self.relu = Mish()
        self.maxpool = GeM()
        self.res_attn1 = AttentionOCT(256, 1024, 512, 4, normalize_attn=normalize_attn)
        self.res_attn2 = AttentionOCT(512, 1024, 512, 2, normalize_attn=normalize_attn)
        self.eff_attn = AttentionOCT(2048, 2048, 512, 1, normalize_attn=normalize_attn)
