...
class Dnet(nn.Module):
    def __init__(self, n, arch = get_cadene_model('densenet121'), pre=True, ps=0.5):
        ...
        self.layer1 = nn.Sequential(
            ...
            m.features.denseOCT1)
        self.layer2 = nn.Sequential(m.features.transition1,m.features.denseOCT2)
        self.layer3 = nn.Sequential(m.features.transition2,m.features.denseOCT3)
        self.layer4 = nn.Sequential(m.features.transition3,m.features.denseOCT4,
                                    m.features.norm5)
